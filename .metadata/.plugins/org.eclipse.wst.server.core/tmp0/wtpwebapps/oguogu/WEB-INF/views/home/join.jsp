        ...
        <form method="post" action="" id="login-form">
        	<div style="display: flex; align-items: center;">
             	<!-- 요청 정보(request)  -->
	           	...
	           	<!-- db로 가서 닉네임 중복 체크함 -->	
	           	<input type="button" onclick="" value="중복체크" id="nick_dupl" style="width:80px; display:none;">
           	</div>
        	<!-- 닉네임 유효성 검사 메세지 -->
           	...
           	<div style="display: flex; align-items: center;">
				...
				<!-- db로 가서 아이디 중복 체크함 -->	
            	<input type="button" onclick="" value="중복체크" id="id_dupl" style="width:80px; display:none;">
            </div>
            <!-- 아이디 유효성 검사 메세지 -->
            ...
            <div style="display: flex; align-items: center;">
				...
				<!-- db로 가서 이메일 중복 체크함 -->	
            	<input type="button" onclick="" value="중복체크" id="email_dupl" style="width:80px; display:none;">
            </div>
            <!-- 이메일 유효성 검사 메세지 -->
            <div id="emailCheck" style="width:400px;"></div>
             ...
             <div id="term-use">
             		<ul>
             			<li><input type="checkbox"><span><b>모두 동의</b></span></li>
             			<li><input type="checkbox"><span>서비스 이용약관 동의</span><a href="https://www.naver.com" target="_blank" class="button-link" style="margin-left:75px;">내용보기</a></li>             			
             			<li><input type="checkbox"><span>개인정보 수집 및 이용 동의</span><a href="https://www.naver.com" target="_blank" class="button-link" style="margin-left:33px;">내용보기</a></li>
             			<li><input type="checkbox"><span>만 14세 이상입니다</span></li>
             			<li><input type="checkbox"><span>(선택) 마케팅 정보 수신 동의</span><a href="https://www.naver.com" target="_blank" class="button-link" style="margin-left:20px;">내용보기</a></li>
             			<!-- 모두 동의 누르면 모든 버튼 눌려야 되고 / 모두 동의 or 선택 제외한 체크박스 눌리면 회원가입 버튼 누를 수 있음 -->
             		</ul>
             </div>
             <div>
             	<input type="submit" id ="join" value="회원가입" style="width:200px; margin-left: 100px; margin-top:20px;"> 
             </div>
        </form>
    </div>
