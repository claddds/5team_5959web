...
<div id="repWrapper" style="margin-right: 200px;">
		...
		<p align="center"><a id="link" href="/ad_faq_list.do">FAQ 전체보기</a></p>
			...
			<tr align="center" >
				...
				<tr align="center" >
					<td style="background-color: #FFA629; color: white;font-weight: bold;border: 2px solid ;" >제목</td>
					<td style="border-radius:20px; border: 3px solid orange;"><input type="text" name="faq_title" size ="20" style="border-radius:20px;"/></td>
				</tr>
			
				<tr align="center">
					<td colspan="2">
						<textarea rows="10" cols="60" name="faq_content" id="content"style="border-radius:20px;" ></textarea>
					</td>
				</tr>
				<tr align="left">
					<td bgcolor="FFA629" align="center"  style="color: white;font-weight: bold">첨부파일</td>
