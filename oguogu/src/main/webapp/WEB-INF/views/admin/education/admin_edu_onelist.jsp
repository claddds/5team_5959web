  ...
  <div >
		...
		<p align="center"><a id="link" href="/admin_edulist.do">교육정보 전체보기</a></p>
		 ...
		 <!-- 파일 첨부하려면  -->
			...
			<tr align="center" >
					<td bgcolor="FFA629" width="150px" style="background-color: #FFA629; border: 3px solid white; color: white;font-weight: bold;">교육종류</td>
					<td align="left" style="border-radius:20px; border: 3px solid orange; ">${evo.edu_kind }</td>
				</tr>
				<tr align="center">
					<td bgcolor="FFA629" style="background-color: #FFA629; border: 3px solid white;  color: white;font-weight: bold;">동물종류</td>
					<td align="left" style="border-radius:20px; border: 3px solid orange; ">${evo.edu_aml_kind }</td>
				</tr>			
				<tr align="center">
					<td bgcolor="FFA629" style="background-color: #FFA629; border: 3px solid white; color: white;font-weight: bold;">작성자</td>
					<td align="left" style="border-radius:20px; border: 3px solid orange; ">${evo.admin_nikname }</td>
				</tr>
				<tr align="center">
					<td bgcolor="FFA629" style="background-color: #FFA629; border: 3px solid white; color: white;font-weight: bold;">제  목</td>
					<td align="left" style="border-radius:20px; border: 3px solid orange; ">${evo.edu_title }</td>
				</tr>
				
				<tr align="center">
					<td bgcolor="FFA629"  style="background-color: #FFA629; border: 3px solid white; color: white;font-weight: bold;">교육 내용 </td>
					<td align="left" style="border-radius:20px; border: 3px solid orange; " >${evo.edu_content }</td>
				
				</tr>
				<tr align="center" >
					<td bgcolor="FFA629"style="background-color: #FFA629; border: 3px solid white; color: white;font-weight: bold;" >교육정보 이미지</td>
					<c:choose>
						<c:when test="${empty evo.edu_F_name }">
							<td align="left" style="border-radius:20px; border: 3px solid orange; "><b>등록된 이미지가 없습니다.</b></td>
						</c:when>
						<c:otherwise>
