...
console.log("현재 페이지: " + ${paging.nowPage});
	...
	function search() {
	    ...
	    if (keyword === "") {
	        ...
	        // 검색어를 포함한 URL 생성
	        var searchUrl = "/edu_search.do?keyword=" + encodeURIComponent(keyword);
	        // 생성한 URL로 이동
	...
	<tr>
		  <td colspan="7">
            ...
            <c:forEach begin="${paging.beginBlock}" end="${paging.endBlock }" step="1" var="k">
               ...
               <c:if test="${k != paging.nowPage}">
                     <!-- a링크처리 -->
                     <li><a href="/edu_search.do?cPage=${k}">${k}</a></li>
               </c:if>
            </c:forEach>
            <!-- 다음 -->
              <c:choose>
...
<!--검색 항목-->
	<div id='liSearchOption' style="margin: auto;">
            	<form name="search" action="/edu_search.do" method="get" onsubmit="return validateSearch()">
                <div>
