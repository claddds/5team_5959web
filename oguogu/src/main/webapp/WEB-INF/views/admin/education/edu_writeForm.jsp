...
<div id="repWrapper" style="margin-right: 200px;">
		...
		<p align="center"><a id="link" href="/admin_edulist.do">교육정보 전체보기</a></p>
			...
			<tr align="center" >
					...
					<td><input type="text" name="admin_nikname" size ="80" value="${nickname}" style="border-radius:20px;" readonly/></td>
					
				</tr>
				<tr align="center" >
					<td style="background-color: #FFA629; color: white;font-weight: bold;border: 2px solid ;">교육 제목</td>
					<td style="border-radius:20px; border: 3px solid orange;"><input type="text" name="edu_title" size ="80" style="border-radius:20px;"/></td>
				</tr>
			
				<tr align="center">
					<td colspan="2" >
						<textarea rows="30" cols="80" name="edu_content" id="content" style="border-radius:20px;" ></textarea>
					</td>
				</tr>
				<tr align="left">
					<td bgcolor="FFA629" align="center"  style="color: white;font-weight: bold;">교육정보 이미지</td>
