		...
		<p align="center"><a id="link" href="/ad_food_list.do">등록상품 전체보기</a></p>
			...
			<td>	
						<select id="fd_age_group"  name="fd_age_group" style="width: 100px;" >		
							<option selected style="display:none;">${ad_f_vo.fd_age_group}</option>
			...
			<tr align="center" >
					...
					<td><input type="text" name="fd_name" size ="80" value="${ad_f_vo.fd_name}" style="border-radius:20px;"/></td>
				</tr>
			<tr align="center" >
					<td bgcolor="FFA629"  style= "color: white; font-weight: bold;">제조회사</td>
					<td><input type="text" name="fd_company" size ="80" value="${ad_f_vo.fd_company}" style="border-radius:20px;"/></td>
				</tr>
			<tr align="center" >
					<td bgcolor="FFA629"  style= "color: white; font-weight: bold;" >상품가격</td>
					<td><input type="number" name="fd_price" size ="80" value="${ad_f_vo.fd_price}" min="0" style="border-radius:20px;"/></td>
				</tr>
					<tr align="center" >
					<td bgcolor="FFA629"  style= "color: white; font-weight: bold;" >구매 링크</td>
					<td><input type="text" name="fd_link" size ="80" value="${ad_f_vo.fd_link}" style="border-radius:20px;"/></td>
				</tr>
				<tr align="center">
					<td colspan="2">
					...
					<tr align="center">
					<td bgcolor="#FFA629"  style= "color: white; font-weight: bold;">상품 이미지</td>
					<c:choose>
						<c:when test="${empty ad_f_vo.fd_fname}">
							<td><input type="file" name="file"> <br><b> 상품 이미지 준비중</b> </td>
							   	<input type="hidden" name = "old_f_name" value="">					
						</c:when>
						<c:otherwise>
							<td><input type="file" name="file"> <br><b> 이전 파일명 (${ad_f_vo.fd_fname})</b> </td>
