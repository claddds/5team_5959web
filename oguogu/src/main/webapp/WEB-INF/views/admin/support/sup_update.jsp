		...
		<p align="center"><a id="link" href="/ad_sup_list.do">공지사항 전체보기</a></p>
			...
			<tr align="center"  style= "color: white; font-weight: bold;">
				...
				<tr align="center" >
					...
					<td><input type="text" name="not_title" size ="80" value="${sup_vo.not_title}" style="border-radius:20px;"/></td>
				</tr>
				...
				<tr align="center">
					...
					<c:choose>
						...
						<c:otherwise>
							<td><input type="file" name="file"> <br><b> 이전 파일명 (${sup_vo.not_fname})</b> </td>
