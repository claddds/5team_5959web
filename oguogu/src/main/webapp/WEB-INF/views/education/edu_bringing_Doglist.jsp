...
<body>
	...
	<div id="eduform">
		...
		<div id="edumenu">
			<ul>
				<li><a href="/bringingdisplayDog.do"># 강아지</a></li>
				<li><a href="/bringingdisplayCat.do"># 고양이</a></li>
			</ul>
		</div>
		...
		<div class="edu_menu_title">
			<label class="label_one">반려 동물 잘 키우는 방법 ! >> </label>
			<label class="label_two"> # 강아지</label>
		</div>
		
		<div class="div_card">
			<ul class="cardList">
			<c:forEach var = "k" items="${DogBlist}">
	...
	<div>
			<ol class="paging">
			   ...
			   <c:choose>
			   		...
			   		<c:otherwise>
			   			<!-- a링크처리 -->
			   			<li><a href="/bringingdisplayDog.do?page=${paging.beginBlock-paging.pagePerBlock}">이전으로</a></li>
			   		</c:otherwise>
			   </c:choose>
			    <!-- 블록안에 들어간 페이지번호들 -->
				<c:forEach begin="${paging.beginBlock}" end="${paging.endBlock }" step="1" var="k">
				   ...
				   <c:if test="${k != paging.nowPage}">
				   		<!-- a링크처리 -->
				   		<li><a href="/bringingdisplayDog.do?page=${k}">${k}</a></li>
				   </c:if>
				</c:forEach>
				<!-- 다음 -->
				  <c:choose>
			   		...
			   		<c:otherwise>
			   			<!-- a링크처리 -->
			   			<li><a href="/bringingdisplayDog.do?page=${paging.beginBlock+paging.pagePerBlock}">다음으로</a></li>
			   		</c:otherwise>
			   </c:choose> 
			</ol>
		</div>
