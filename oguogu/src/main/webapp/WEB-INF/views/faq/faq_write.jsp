...
<body>
	...
	<div id="faqtWrapper" style="width: 1920px;">
	...
	<div id="faq_write">
		<form action="qinsert.do" method="post"
			...
			<table width="1200px;"  border="1px solid" cellpadding="0"
				...
				<tr height="50">
					<th>첨부파일</th>
					<td style="padding: 8px; text-align: left;"><input name="faq_fname" type="file" style="font-size: 20px;"/></td>
				</tr>
				<tr height="50">
					<th>비밀번호</th>
