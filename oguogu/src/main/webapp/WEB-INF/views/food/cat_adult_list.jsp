...
$(document).ready(function() {
	$.ajax({
		  ...
		  success: function(data) {
		    ...
		    $("#catAdultAges").css("background-color", "tomato");
		    $("#catKittenAges, #catAllAges, #catSeniorAges").css("background-color", "");
...
<body>
	...
	<!-- 	<div id="sort">
		...
		<div>
			<ul id="prod-list">
				<c:forEach var="k" items="${CatFoodAdultlist}">
