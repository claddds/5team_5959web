...
$(document).ready(function() {
	$.ajax({
		  url: '/catFoodKitten.do',
		  type: 'GET',
		  success: function(data) {
		    // Ajax 요청이 성공했을 때 실행되는 코드
		    $("#feed").css("color", "tomato");
		    $("#catKittenAges").css("background-color", "tomato");
		    $("#catAdultAges, #catAllAges, #catSeniorAges").css("background-color", "");
...
<body>
	...
	<!-- 	<div id="sort">
		...
		<div>
			<ul id="prod-list">
				<c:forEach var="k" items="${CatFoodKittenlist}">
