...
$(document).ready(function() {
	$.ajax({
		  url: '/dogFooddesert.do',
		  type: 'GET',
		  success: function(data) {
		    // Ajax 요청이 성공했을 때 실행되는 코드
		    $("#desert").css("color", "tomato");
...
<body>
	...
	<div id = "dog-food-form">
		...
		<div style="display:flex;justify-content: center; margin:50px;">
			<img src="resources/images/food/dog_desert.png" style="width:200px;height:200px;border-radius:10px;">
		</div>
		<div>
			<ul id="prod-list">
				<c:choose>
					<c:when test="${not empty DogDesertlist}">
						<c:forEach var="k" items="${DogDesertlist}">
