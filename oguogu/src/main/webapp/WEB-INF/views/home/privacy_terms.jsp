...
<body>
	...
	<div id="content">
	<h1 style="margin-bottom:60px;display:flex;justify-content: center; font-size: 60px;">개인정보처리방침</h1>
	...
	<div>
		...
		5. 이용자는 개인정보 보호법 등 관계법령을 위반하여 회사가 처리하고 있는 이용자 본인이나 타인의 개인정보 및 사생활을 침해하여서는 아니 됩니다.<br>
	</div>
	<h2>개인정보의 파기</h2>
	<div>
		1. 회사는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.<br>
		2. 회사는 다음의 방법으로 개인정보를 파기합니다.<br>
	...
	<h2>개인정보 보호책임자</h2>
		<div>
			회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제를 처리하기 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br><br>
	
			개인정보 보호책임자<br><br>
				
			성명 : 탁영송, 직책 : 대표이사<br><br>
	
			연락처 : 010-2875-2217, poiu62875@gmail.com<br><br>
