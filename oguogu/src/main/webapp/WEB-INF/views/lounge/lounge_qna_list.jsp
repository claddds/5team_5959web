...
<!-- 리스트 배너 구역 -->
	<div id=minibanner>
		<a href="/loungeqnadisplay.do"><img src="resources/images/page_banner/listbanner_lounge.png"></a>
	</div>
<div id="loungeWrapper" style="width: 1920px;">
    ...
    <ul class="sidebar-menu">
      ...
      <hr>
      <li class="question" style="font-weight: bold;"><a href="/lounge_qna_list.do">질문</a></li>
      <!-- 기타 사이드바 메뉴 항목 추가 -->
    </ul>
  </div>
  <!-- 게시판 리스트 구역 -->
  ...
  <tbody>
  <c:choose>
	<c:when test="${empty lounge_qna_list}">
		<tr>
			<td colspan="7"><h2 style="text-align: center;">자료가 존재하지 않습니다.</h2></td>
		</tr>
	</c:when>
	<c:otherwise>
		<c:forEach var="l" items="${lounge_qna_list}" varStatus="vs">
			<tr>
