...
<body>
	...
	<div id="mywrite_lounge_form">
		<div style="margin-top:10px;">
			<jsp:include page="mypage-sidebar.jsp" />
		</div>
		<div id="mywrite_lounge_list">
			<div style="font-size: 50px;font-family: 'Noto Sans KR', sans-serif; color:#FFA629; margin-bottom:50px;font-weight: bold;">나의 작성글</div>
