...
<body>
	...
	<form id="write-pet-profile-form">
		...
		<div id="write-pet-profile">
			...
			<!-- 이름 입력 -->
			<div id="pet-name">
				<span class="pet_essential">*</span><input type="text" placeholder="이름(문자와 숫자를 활용해 1-10자만 입력해주세요)" maxlength="10" />
			</div>
			<div><!-- 이름 조건 확인해달라는 유효성 메세지 --></div>
			<div id="pet-birth">
				<span class="pet_essential">*</span><input type="text" placeholder="반려동물의 생년월일" />
			</div>
			<div><!-- 생년월일 8자리 입력하라고 유효성 메세지 --></div>
			<!-- 강아지, 고양이 선택 -->
			<div id="pet-choice">
