...
<body>
	...
	<main class="sc-bCDidY kZZDuN ageJsp">
		...
		<div class="sc-ldFCYb dDWxH">
			...
			<img src="/resources/images/ageMain.png"
					...
					<div class="sc-cYRmzm sXbo">
						...
						<div class="sc-fGjrnr jGNyzc">
							<div class="sc-dsInJy iempoK selPet">
								<img src="/resources/images/dog.png" 
						...
						<div class="sc-gHbYXZ iunTGn">
							<div class="sc-crPCXo ioNcga">
								<label color="#cfcece" class="sc-dExYQz jXKbJV"><input
									type="radio" class="sc-bqWVmG eYsNwq" value="소형">소형</label>
							</div>
							<div class="sc-crPCXo ioNcga">
								<label color="#cfcece" class="sc-dExYQz jXKbJV"><input
									type="radio" class="sc-bqWVmG eYsNwq" value="중형">중형</label>
							</div>
							<div class="sc-crPCXo ioNcga">
								<label color="#cfcece" class="sc-dExYQz jXKbJV"><input
									type="radio" class="sc-bqWVmG eYsNwq" value="대형">대형</label>
							</div>
						</div>
					</div>
				</div>
...
function init(){
	...
	$jsp.find('.getResult').on('click',function(){
		location.replace('/age_result.do')
	});
};
</script>
</html>